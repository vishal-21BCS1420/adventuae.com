...
<!-- site metas -->
<title>Advent Technologies</title>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
          <!-- logo start -->
          <div class="logo"> <a href="it_home.html"><img src="images/logos/advent.png" alt="logo" /></a> </div>
          <!-- logo end -->
        </div>
          ...
          <ul>
            <li data-index="rs-1812" data-transition="zoomin" data-slotamount="7"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"  data-thumb="images/it_service/slide1.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Computer Services" data-description="">
              ...
              <div class="tp-caption NotGeneric-SubTitle   tp-resizeme rs-parallaxlevel-0" 
                              ...
                              data-splitout="none" 
                              data-responsive_offset="on" 
                              style="z-index: 7; white-space: nowrap;">Available On Advent Technologies </div>
            </li>
    ...
    <div class="row">
      <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
        <div class="full text_align_center margin_bottom_30">
          ...
          <h4 class="theme_color">Hard Disk Services</h4>
          <p>We repair and replace the hard disk and SSD if you require at an affordable price.</p>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
        <div class="full text_align_center margin_bottom_30">
          ...
          <p>Our technicians provide affordable solutions for hardware and software issues.</p>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
        <div class="full text_align_center margin_bottom_30">
          ...
          <p> Our skilled technicians fix screens, batteries, and software issues fast and affordably. </p>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
        <div class="full text_align_center margin_bottom_30 margin_0">
          ...
          <p> We offer reliable setup, maintenance, and security for homes and businesses.</p>
        </div>
      </div>
    </div>
